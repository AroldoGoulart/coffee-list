...
const BUNDLE_ID = 'com.simple.apipconsumer'; // ios bundle id
const PACKAGE = 'com.simple.apipconsumer'; // android package name
const NAME = 'ApiConsumer'; // app name
const EXPO_ACCOUNT_OWNER = ''; // expo account owner
const EAS_PROJECT_ID = ''; // eas project id
const SCHEME = 'ApiConsumer'; // app scheme
